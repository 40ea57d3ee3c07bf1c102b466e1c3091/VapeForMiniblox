...
(function() {
	...
	addReplacement('async loadSpritesheet(){', `
		async loadVape() {
			this.vapeTexture = await this.loader.loadAsync("https://raw.githubusercontent.com/40ea57d3ee3c07bf1c102b466e1c3091/VapeForMiniblox/main/assets/logo.png");
			this.v4Texture = await this.loader.loadAsync("https://raw.githubusercontent.com/40ea57d3ee3c07bf1c102b466e1c3091/VapeForMiniblox/main/assets/logov4.png");
		}
	...
	addReplacement('async downloadSkin(_){', `
		if (_ == "GrandDad") {
			...
			return new Promise((et, tt) => {
				textureManager.loader.load("https://raw.githubusercontent.com/40ea57d3ee3c07bf1c102b466e1c3091/VapeForMiniblox/main/assets/skin.png", rt => {
					const nt = {
						atlas: rt,
						id: _,
						skinny: $.skinny,
	...
	addReplacement('async downloadCape(_){', `
		if (_ == "GrandDad") {
			const $ = capes[_];
			return new Promise((et, tt) => {
				textureManager.loader.load("https://raw.githubusercontent.com/40ea57d3ee3c07bf1c102b466e1c3091/VapeForMiniblox/main/assets/cape.png", rt => {
					const nt = {
						atlas: rt,
						id: _,
						name: $.name,
